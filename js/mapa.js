window.onload = function() {
  ...
  // Creem una imatge cercle dins d'un template image series perquè es repliqui a totes les noves imatges
  ...
  circle.events.on("hit", function(event) {
   ...
   // }
    ...
    //Mostrem la informació dels paísos a un modal
  ...
  //Aquesta funció serveix perque certs cercles no es vegin si no es fa un mínim de zoom (propietat minZoom)
  ...
  imageSeries.data = [
    {
      ...
      radio2: "http://catinform.ccma.audioemotion.stream.flumotion.com/ccma/catinform.mp3",
      informacio: {
        "pais": "Espanya",
    ...
    },
    {
      ...
      radio2: "http://18843.live.streamtheworld.com/CFRBAM.mp3",
      informacio: {
        "pais": "Canadà",
